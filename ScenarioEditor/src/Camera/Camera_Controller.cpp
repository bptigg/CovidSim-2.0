...
void Camera_Controller::On_Update()
{
	...
	{
		m_camera_position.x -= cos(glm::radians(m_camera_rotation)) * m_camera_translation_speed;
		m_camera_position.y -= sin(glm::radians(m_camera_rotation)) * m_camera_translation_speed;
	}
	...
	{
		m_camera_position.x += -sin(glm::radians(m_camera_rotation)) * m_camera_translation_speed;
		m_camera_position.y += cos(glm::radians(m_camera_rotation)) * m_camera_translation_speed;
	}
